...
def main() -> None:
    ...
    parser.add_argument("--load_checkpoint", default="",
                         help="Load a fedrag 'main.py fl-train --save-best' LoRA checkpoint as a frozen "
                              ...
                              "LoRA rank/alpha/target_modules must match gretriever's defaults (r=8, alpha=16, "
    ...
    parser.add_argument("--save_root", default="",
                         help="Where to write summary.json. Defaults to output/baselines/gretriever; "
                              "point it elsewhere (e.g. output/baselines_lora/gretriever) to keep a "
    ...
    if args.client is not None:
        ...
        log_baseline_result("gretriever", args.dataset, result)
    else:
        if args.save_root:
        ...
        log_baseline_result("gretriever", args.dataset, summary)
